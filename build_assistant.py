...
def gen_raw_events(autogen_config, symbol_registry):
    ...
    def gen_base_raw_event():
        ...
        h_source = AutoGeneratedSource(base_path, class_name, 'h', CODE_GEN_CFG, symbol_registry)
        ...
        h_source \
            .declare_fn('operator<< ', 'QDebug', ('QDebug', 'stream'), ('CPTR(RawEvent)', 'event')) \
            .commit(BASE_SRC_DIR)

        cpp_source = AutoGeneratedSource(base_path, class_name, 'cpp', CODE_GEN_CFG, symbol_registry) \
            .cover_symbols(h_source.get_covered_symbols())

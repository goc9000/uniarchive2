...
#ifndef UNIARCHIVE2_PROTOCOLS_JABBER_JABBER_ACCOUNT_NAME_H
#define UNIARCHIVE2_PROTOCOLS_JABBER_JABBER_ACCOUNT_NAME_H
...
#endif //UNIARCHIVE2_PROTOCOLS_JABBER_JABBER_ACCOUNT_NAME_H

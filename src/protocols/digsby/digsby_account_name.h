...
#ifndef UNIARCHIVE2_PROTOCOLS_DIGSBY_DIGSBY_ACCOUNT_NAME_H
#define UNIARCHIVE2_PROTOCOLS_DIGSBY_DIGSBY_ACCOUNT_NAME_H
...
#endif //UNIARCHIVE2_PROTOCOLS_DIGSBY_DIGSBY_ACCOUNT_NAME_H

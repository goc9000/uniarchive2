 ...
 * Codegen hash (sha256): aa532cef677138a2956ec7a10ae803d190b4129bbeba01dda9cd5732b25e73fd
 *
...
QString name_for_im_protocol(IMProtocol protocol) {
    ...
    invariant_violation("Invalid IMProtocol value (%d)", protocol);
}

 ...
 * Codegen hash (sha256): 64770e8fb467c1b3150436e6b325e3f861c7c5b980688220090e1576b369ef8f
 *
...
bool LinkTag::visitSubjectsImpl(IMM(visit_subjects_callback_t) UNUSED callback) const {
    // No fields to visit
    return true;
}

bool LinkTag::alterSubjectsImpl(IMM(alter_subjects_callback_t) UNUSED callback) {
    // No fields to visit
    return true;
}

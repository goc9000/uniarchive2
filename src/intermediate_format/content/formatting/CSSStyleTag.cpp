 ...
 * Codegen hash (sha256): 71be18ce8099b617c6b975050e7cacba4627c7ab4dd4dcffdf91c5ecd4cedc76
 *
...
bool CSSStyleTag::visitSubjectsImpl(IMM(visit_subjects_callback_t) UNUSED callback) const {
    // No fields to visit
    return true;
}

bool CSSStyleTag::alterSubjectsImpl(IMM(alter_subjects_callback_t) UNUSED callback) {
    // No fields to visit
    return true;
}

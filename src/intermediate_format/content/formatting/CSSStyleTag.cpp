 ...
 * Codegen hash (sha256): 54ad1f92a49a95abe8230d991505d444705da1ffbd68882123c0978123961018
 *
...
bool CSSStyleTag::visitSubjectsImpl(IMM(visit_subjects_callback_t) UNUSED callback) {
    // No fields to visit
    return true;
}

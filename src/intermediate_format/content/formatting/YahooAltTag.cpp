 ...
 * Codegen hash (sha256): 9a86889a61f7a7f1f85bc203498fc13e733046b25841335aea1dcd8fd5b581f9
 *
...
bool YahooAltTag::visitSubjectsImpl(IMM(visit_subjects_callback_t) UNUSED callback) const {
    // No fields to visit
    return true;
}

bool YahooAltTag::alterSubjectsImpl(IMM(alter_subjects_callback_t) UNUSED callback) {
    // No fields to visit
    return true;
}

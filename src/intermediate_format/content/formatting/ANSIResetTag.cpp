 ...
 * Codegen hash (sha256): 7f194e98d588b31ac4d1cc9ec57713654c6db02f8bdead370ac63e59334370cf
 *
...
bool ANSIResetTag::visitSubjectsImpl(IMM(visit_subjects_callback_t) UNUSED callback) const {
    // No fields to visit
    return true;
}

bool ANSIResetTag::alterSubjectsImpl(IMM(alter_subjects_callback_t) UNUSED callback) {
    // No fields to visit
    return true;
}

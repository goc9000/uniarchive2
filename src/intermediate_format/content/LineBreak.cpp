 ...
 * Codegen hash (sha256): bb47f13488771ac099388d06ee30a3c96edca4662f32cc6e70001865c81ae270
 *
...
bool LineBreak::visitSubjectsImpl(IMM(visit_subjects_callback_t) UNUSED callback) const {
    // No fields to visit
    return true;
}

bool LineBreak::alterSubjectsImpl(IMM(alter_subjects_callback_t) UNUSED callback) {
    // No fields to visit
    return true;
}

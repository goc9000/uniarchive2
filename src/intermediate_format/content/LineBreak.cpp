 ...
 * Codegen hash (sha256): 28cc04c882c9619b9134680039428673e636ec5c1a87ac3abfefa45bfb65bb36
 *
...
bool LineBreak::visitSubjectsImpl(IMM(visit_subjects_callback_t) UNUSED callback) {
    // No fields to visit
    return true;
}

 ...
 * Codegen hash (sha256): 8cc23357a7ca50084effc6af50c746106af8e56c89715d151175f3fc2f34ed15
 *
...
bool TextSection::visitSubjectsImpl(IMM(visit_subjects_callback_t) UNUSED callback) const {
    // No fields to visit
    return true;
}

bool TextSection::alterSubjectsImpl(IMM(alter_subjects_callback_t) UNUSED callback) {
    // No fields to visit
    return true;
}

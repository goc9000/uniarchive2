 ...
 * Codegen hash (sha256): ff4bb72c4a8b1ccae2cce29827bbb6329e8d427475be92fc4338718ed2943061
 *
...
bool FlagIcon::visitSubjectsImpl(IMM(visit_subjects_callback_t) UNUSED callback) const {
    // No fields to visit
    return true;
}

bool FlagIcon::alterSubjectsImpl(IMM(alter_subjects_callback_t) UNUSED callback) {
    // No fields to visit
    return true;
}

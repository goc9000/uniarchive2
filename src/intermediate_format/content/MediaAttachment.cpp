 ...
 * Codegen hash (sha256): 4665fc9239d17f1e845693e867ea1d36576e1fde6113265d1a07bf23acb8edae
 *
...
bool MediaAttachment::visitSubjectsImpl(IMM(visit_subjects_callback_t) UNUSED callback) {
    // No fields to visit
    return true;
}

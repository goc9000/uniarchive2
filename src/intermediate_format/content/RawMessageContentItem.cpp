 ...
 * Codegen hash (sha256): a3c0ddeb8b992ddef4554cb34b5c9c750907e35faa7eb7dc416e842289e86892
 *
...
bool RawMessageContentItem::visitSubjects(IMM(visit_subjects_callback_t) callback) const {
    return visitSubjectsImpl(callback);
}

bool RawMessageContentItem::alterSubjects(IMM(alter_subjects_callback_t) callback) {

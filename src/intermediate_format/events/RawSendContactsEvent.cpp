 ...
 * Codegen hash (sha256): 4c633c6fa2e3c4efe0451adac3ecbe81798e8fa2e0f499a59f7c37ff18b78513
 *
...
bool RawSendContactsEvent::visitSubjectsImpl(IMM(visit_subjects_callback_t) callback) const {
    return visit_subjects(sender, callback) && visit_subjects(contacts, callback);
}

bool RawSendContactsEvent::alterSubjectsImpl(IMM(alter_subjects_callback_t) callback) {
    return alter_subjects(sender, callback) && alter_subjects(contacts, callback);
}

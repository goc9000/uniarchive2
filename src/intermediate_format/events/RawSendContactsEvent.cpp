 ...
 * Codegen hash (sha256): 42f60d0416f525d64831482f85b2a814b4ba8524fa492c64cf349e574d53fbe1
 *
...
bool RawSendContactsEvent::visitSubjectsImpl(IApparentSubjectVisitor& visitor) {
    return visit_subjects(sender, visitor) && visit_subjects(contacts, visitor);
}

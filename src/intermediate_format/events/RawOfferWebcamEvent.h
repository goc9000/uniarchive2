...
#ifndef UNIARCHIVE2_INTERMEDIATE_FORMAT_EVENTS_IFOFFERWEBCAMEVENT_H
#define UNIARCHIVE2_INTERMEDIATE_FORMAT_EVENTS_IFOFFERWEBCAMEVENT_H
...
#endif //UNIARCHIVE2_INTERMEDIATE_FORMAT_EVENTS_IFOFFERWEBCAMEVENT_H

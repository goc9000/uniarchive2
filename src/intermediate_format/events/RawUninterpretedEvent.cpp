 ...
 * Codegen hash (sha256): a27bfa6de09c7683e280781458ed6315e8d3de9d95b23c65283acf7e1e0b8cf7
 *
...
bool RawUninterpretedEvent::visitSubjectsImpl(IMM(visit_subjects_callback_t) UNUSED callback) const {
    // No fields to visit
    return true;
}

bool RawUninterpretedEvent::alterSubjectsImpl(IMM(alter_subjects_callback_t) UNUSED callback) {
    // No fields to visit
    return true;
}

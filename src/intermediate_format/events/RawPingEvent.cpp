 ...
 * Codegen hash (sha256): bad89f3d0570ab225eb955b8687abdacb68c3b76906902ecfaed826828681ece
 *
...
bool RawPingEvent::visitSubjectsImpl(IMM(visit_subjects_callback_t) callback) const {
    return visit_subjects(pinger, callback) && visit_subjects(pingee, callback);
}

bool RawPingEvent::alterSubjectsImpl(IMM(alter_subjects_callback_t) callback) {
    return alter_subjects(pinger, callback) && alter_subjects(pingee, callback);
}

 ...
 * Codegen hash (sha256): 5e5bc7c001b002c4929fba11614a1dad2801ed8ce349c3c766b09d59929ebe24
 *
...
bool RawContactRequestEvent::visitSubjectsImpl(IMM(visit_subjects_callback_t) callback) const {
    return visit_subjects(sender, callback) && visit_subjects(receiver, callback) && visit_subjects(message, callback);
}

bool RawContactRequestEvent::alterSubjectsImpl(IMM(alter_subjects_callback_t) callback) {
    return alter_subjects(sender, callback) && alter_subjects(receiver, callback) && alter_subjects(message, callback);
}

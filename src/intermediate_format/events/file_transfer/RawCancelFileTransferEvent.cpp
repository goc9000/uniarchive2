 ...
 * Codegen hash (sha256): 4a96e7244a597a43b1ec3d44eb9065fa21f76f70d257b606344cdc594d7faf87
 *
...
bool RawCancelFileTransferEvent::visitSubjectsImpl(IMM(visit_subjects_callback_t) callback) const {
    return visit_subjects(actor, callback);
}

bool RawCancelFileTransferEvent::alterSubjectsImpl(IMM(alter_subjects_callback_t) callback) {
    return alter_subjects(actor, callback);
}

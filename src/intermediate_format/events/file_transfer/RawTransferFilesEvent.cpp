 ...
 * Codegen hash (sha256): 13f5b1c72a4b86f67edd89ba49737e22163dbdc103232ec020fbd48ca3491e37
 *
...
bool RawTransferFilesEvent::visitSubjectsImpl(IMM(visit_subjects_callback_t) callback) const {
    return visit_subjects(sender, callback) && visit_subjects(recipient, callback);
}

bool RawTransferFilesEvent::alterSubjectsImpl(IMM(alter_subjects_callback_t) callback) {

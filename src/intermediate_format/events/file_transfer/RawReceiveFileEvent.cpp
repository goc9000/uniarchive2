 ...
 * Codegen hash (sha256): 239a23ca2408a64ba89e35e774a7e82224d722b63af8917f3d9f6422a87ab52b
 *
...
bool RawReceiveFileEvent::visitSubjectsImpl(IMM(visit_subjects_callback_t) callback) const {
    return visit_subjects(receiver, callback) && visit_subjects(sender, callback);
}

bool RawReceiveFileEvent::alterSubjectsImpl(IMM(alter_subjects_callback_t) callback) {
    return alter_subjects(receiver, callback) && alter_subjects(sender, callback);
}

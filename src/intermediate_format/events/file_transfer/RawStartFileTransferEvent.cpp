 ...
 * Codegen hash (sha256): b23d47b17a900bf2ab48a560f06ba3a27dc7ac8eb1106980234127a72dc20485
 *
...
bool RawStartFileTransferEvent::visitSubjectsImpl(IApparentSubjectVisitor& visitor) {
    return visit_subjects(sender, visitor);
}

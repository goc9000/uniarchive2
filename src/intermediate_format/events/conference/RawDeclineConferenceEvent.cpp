 ...
 * Codegen hash (sha256): fd2ee9cdd5c2735cdc6be720292a90a619f914deb5fd6f6e7075c79ac77e8b6d
 *
...
bool RawDeclineConferenceEvent::visitSubjectsImpl(IApparentSubjectVisitor& visitor) {
    return visit_subjects(subject, visitor) && visit_subjects(message, visitor);
}

 ...
 * Codegen hash (sha256): 62179659f59c4110d1d3d4853e497f436fc4a5c7b548ec55b494f28845044ab8
 *
...
bool RawAddToConferenceEvent::visitSubjectsImpl(IMM(visit_subjects_callback_t) callback) const {
    return visit_subjects(adder, callback) && visit_subjects(addees, callback);
}

bool RawAddToConferenceEvent::alterSubjectsImpl(IMM(alter_subjects_callback_t) callback) {
    return alter_subjects(adder, callback) && alter_subjects(addees, callback);
}

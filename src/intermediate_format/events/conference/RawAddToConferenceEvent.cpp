 ...
 * Codegen hash (sha256): c420e6a328ae9a0732dab7c11895e8369ee891945bdb9fd8ca652c85012e5b8d
 *
...
bool RawAddToConferenceEvent::visitSubjectsImpl(IApparentSubjectVisitor& visitor) {
    return visit_subjects(adder, visitor) && visit_subjects(addees, visitor);
}

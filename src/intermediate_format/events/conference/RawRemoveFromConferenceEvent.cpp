 ...
 * Codegen hash (sha256): 17156650cbd1a09330b5ffd43e52db91410879c87b85e702b9f72564b2e829af
 *
...
bool RawRemoveFromConferenceEvent::visitSubjectsImpl(IMM(visit_subjects_callback_t) callback) const {
    return visit_subjects(remover, callback) && visit_subjects(removee, callback);
}

bool RawRemoveFromConferenceEvent::alterSubjectsImpl(IMM(alter_subjects_callback_t) callback) {
    return alter_subjects(remover, callback) && alter_subjects(removee, callback);
}

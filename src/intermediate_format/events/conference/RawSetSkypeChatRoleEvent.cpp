 ...
 * Codegen hash (sha256): 01d741a9cbc3cdc9a5f0de91f0bd0ab40ce552324cbe1a489fd8ff2052007474
 *
...
bool RawSetSkypeChatRoleEvent::visitSubjectsImpl(IMM(visit_subjects_callback_t) callback) const {
    return visit_subjects(setter, callback) && visit_subjects(target, callback);
}

bool RawSetSkypeChatRoleEvent::alterSubjectsImpl(IMM(alter_subjects_callback_t) callback) {
    return alter_subjects(setter, callback) && alter_subjects(target, callback);
}

 ...
 * Codegen hash (sha256): 839b1f732ab20f10826be5c4e5d3786cc6c3688f77985fd8ed7289ffd2145baf
 *
...
bool RawChangeTopicEvent::visitSubjectsImpl(IMM(visit_subjects_callback_t) callback) const {
    return visit_subjects(subject, callback) && visit_subjects(topic, callback);
}

bool RawChangeTopicEvent::alterSubjectsImpl(IMM(alter_subjects_callback_t) callback) {
    return alter_subjects(subject, callback) && alter_subjects(topic, callback);
}

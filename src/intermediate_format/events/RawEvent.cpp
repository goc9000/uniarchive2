 ...
 * Codegen hash (sha256): d4b3d83148a0cd19240d8dc771d40a04322633e6060824343c50da5e961abc7a
 *
...
bool RawEvent::visitSubjects(IMM(visit_subjects_callback_t) callback) const {
    return visitSubjectsImpl(callback);
}

bool RawEvent::alterSubjects(IMM(alter_subjects_callback_t) callback) {
    return alterSubjectsImpl(callback);
}
...
CEDE(RawEvent) RawEvent::deserializeFromStream(QDataStream& mut_stream) {
    ...
    switch (subtype) {
        ...
        case RawEventSubType::BIRTHDAY_NOTIFICATION:
            return RawBirthdayNotificationEvent::deserializeFromStream(mut_stream, true);

 ...
 * Codegen hash (sha256): 13be921bb19f1e4ed0defdeb5d0ca8e22184f3ddef83dc7f1d568ed88cfc0e63
 *
...
void RawEvent::visitSubjects(ApparentSubjectVisitor& visitor) {
    visitSubjectsImpl(visitor);
}

 ...
 * Codegen hash (sha256): 94aafa9a54ddced1a7cb47252e7106560eea36fda1be8f1d53fad8dbc96d6338
 *
...
bool RawStartCallEvent::visitSubjectsImpl(IApparentSubjectVisitor& visitor) {
    return visit_subjects(initiator, visitor) && visit_subjects(peers, visitor);
}

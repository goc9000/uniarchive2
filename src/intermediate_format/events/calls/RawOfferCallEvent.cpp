 ...
 * Codegen hash (sha256): b37e47039937c14f71cfedecc3a6ec9629c83c1a34ba807a4f655d5fc804d88a
 *
...
bool RawOfferCallEvent::visitSubjectsImpl(IApparentSubjectVisitor& visitor) {
    return visit_subjects(caller, visitor);
}

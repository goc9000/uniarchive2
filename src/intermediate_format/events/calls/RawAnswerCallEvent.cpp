 ...
 * Codegen hash (sha256): c2c603a605352ac92b5b2aab013ecd8bea97e3fcafc8aec712f3541e6b7246a3
 *
...
bool RawAnswerCallEvent::visitSubjectsImpl(IMM(visit_subjects_callback_t) callback) const {
    return visit_subjects(receiver, callback) && visit_subjects(caller, callback);
}

bool RawAnswerCallEvent::alterSubjectsImpl(IMM(alter_subjects_callback_t) callback) {
    return alter_subjects(receiver, callback) && alter_subjects(caller, callback);
}

 ...
 * Codegen hash (sha256): a94230d2b6a96763cfc78db611a6745e269f74ee138f7eb9629884afa5d52c36
 *
...
bool RawDisconnectedEvent::visitSubjectsImpl(IMM(visit_subjects_callback_t) callback) const {
    return visit_subjects(subject, callback);
}

bool RawDisconnectedEvent::alterSubjectsImpl(IMM(alter_subjects_callback_t) callback) {

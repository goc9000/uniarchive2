 ...
 * Codegen hash (sha256): 32b0323bb01e9037e3f62f367c4b26ea2f86db37bc24d93e163f2b49c596f664
 *
...
bool RawCorruptedMessageEvent::visitSubjectsImpl(IMM(visit_subjects_callback_t) UNUSED callback) const {
    // No fields to visit
    return true;
}

bool RawCorruptedMessageEvent::alterSubjectsImpl(IMM(alter_subjects_callback_t) UNUSED callback) {
    // No fields to visit
    return true;
}

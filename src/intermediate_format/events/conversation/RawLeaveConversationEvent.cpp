 ...
 * Codegen hash (sha256): bcc0f133caaee6b33821ef358acbc4b023a177c15b7e3883523d164856e857cb
 *
...
bool RawLeaveConversationEvent::visitSubjectsImpl(IMM(visit_subjects_callback_t) callback) const {
    return visit_subjects(subject, callback);
}

bool RawLeaveConversationEvent::alterSubjectsImpl(IMM(alter_subjects_callback_t) callback) {

 ...
 * Codegen hash (sha256): 93227f71948d06e165bea09af9d3a9daf624c7e5aa63bb6f6054ef2a0d5cdd2d
 *
...
bool RawStartConversationEvent::visitSubjectsImpl(IApparentSubjectVisitor& visitor) {
    return visit_subjects(initiator, visitor) && visit_subjects(peer, visitor);
}

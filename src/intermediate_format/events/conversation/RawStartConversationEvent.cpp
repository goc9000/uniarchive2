 ...
 * Codegen hash (sha256): 7e11dc44eaad45c7b7f33bbbfc2ebc6d07d85d5800ef3440cc244bdf3a30e48e
 *
...
bool RawStartConversationEvent::visitSubjectsImpl(IMM(visit_subjects_callback_t) callback) const {
    return visit_subjects(initiator, callback) && visit_subjects(peer, callback);
}

bool RawStartConversationEvent::alterSubjectsImpl(IMM(alter_subjects_callback_t) callback) {
    return alter_subjects(initiator, callback) && alter_subjects(peer, callback);
}

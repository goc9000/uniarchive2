 ...
 * Codegen hash (sha256): 1f351c8b6677c78c7283d20a33673326956419ef3efb923a06afd067d38c5709
 *
...
bool RawEditedPreviousMessageEvent::visitSubjectsImpl(IMM(visit_subjects_callback_t) callback) const {
    return visit_subjects(subject, callback);
}

bool RawEditedPreviousMessageEvent::alterSubjectsImpl(IMM(alter_subjects_callback_t) callback) {

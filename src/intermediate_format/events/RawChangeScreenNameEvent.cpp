 ...
 * Codegen hash (sha256): f91dcc04ca650eefc9765fbc3c05ba1a6122dc947b3e5d555e0097ce4be36681
 *
...
bool RawChangeScreenNameEvent::visitSubjectsImpl(IMM(visit_subjects_callback_t) callback) const {
    return visit_subjects(from, callback) && visit_subjects(to, callback);
}

bool RawChangeScreenNameEvent::alterSubjectsImpl(IMM(alter_subjects_callback_t) callback) {
    return alter_subjects(from, callback) && alter_subjects(to, callback);
}

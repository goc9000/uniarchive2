 ...
 * Codegen hash (sha256): 351e92ae3e21c18b9032795de1fd28c0cf845c0fd9b3978614e512add9df15c4
 *
...
bool RawMessageEvent::visitSubjectsImpl(IApparentSubjectVisitor& visitor) {
    return visit_subjects(sender, visitor) && visit_subjects(receiver, visitor) && visit_subjects(editedBy, visitor);
}

 ...
 * Codegen hash (sha256): 1bf6aa1127463a83c66ff1de04a4a7417833478ab3546513bf867863cd10a446
 *
...
bool RawMessageEvent::visitSubjectsImpl(IMM(visit_subjects_callback_t) callback) const {
    return
        visit_subjects(sender, callback) && visit_subjects(receiver, callback) && visit_subjects(content, callback) && visit_subjects(editedBy, callback);
}

bool RawMessageEvent::alterSubjectsImpl(IMM(alter_subjects_callback_t) callback) {
    return
        alter_subjects(sender, callback) && alter_subjects(receiver, callback) && alter_subjects(content, callback) && alter_subjects(editedBy, callback);
}

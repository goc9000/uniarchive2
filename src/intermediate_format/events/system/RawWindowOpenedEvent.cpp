 ...
 * Codegen hash (sha256): f98b12c06916745a6c159b1d82f1762f1f7b08d386333b7befc20b17f4b7cb12
 *
...
bool RawWindowOpenedEvent::visitSubjectsImpl(IMM(visit_subjects_callback_t) UNUSED callback) {
    // No fields to visit
    return true;
}

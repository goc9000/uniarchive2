 ...
 * Codegen hash (sha256): dd48135f267dacff1c46050f1ad5af2e9bea2bb606378731abd6d7b1e75aad29
 *
...
bool RawBirthdayNotificationEvent::visitSubjectsImpl(IMM(visit_subjects_callback_t) callback) const {
    return visit_subjects(subject, callback);
}

bool RawBirthdayNotificationEvent::alterSubjectsImpl(IMM(alter_subjects_callback_t) callback) {

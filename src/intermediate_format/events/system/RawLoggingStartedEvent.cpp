 ...
 * Codegen hash (sha256): 7ade57d5b35860db5d2c93a4ff29b9642857913abab8d24add70aa699442258b
 *
...
bool RawLoggingStartedEvent::visitSubjectsImpl(IMM(visit_subjects_callback_t) UNUSED callback) {
    // No fields to visit
    return true;
}
